...
def main():
    dict1 = {}
    directory = "E:\\Studies\\DL\\project\\BookQnA\\src\\books\\test\\pragraphs\\"
    count = 0;
    for filename in os.listdir(directory):
        file = directory + filename;
        doc = codecs.open(file, 'r', 'UTF-8').read()
        passage_retriever.fit(doc)
        qna = codecs.open("E:\\Studies\\DL\\project\\BookQnA\\src\\books\\test\\QnA\\" + filename, 'r',
                          'UTF-8').readlines()
        print(qna)
        right_ans = 0
        i = 0
        ...
        file1 = open("performance_analysis.txt", "a")  # append mode
        file1.write(result)
        file1.close()
    ...
    for key, value in dict1.items():
        ...
        print()
    file2 = open("performance_analysis.txt", "a")  # append mode
